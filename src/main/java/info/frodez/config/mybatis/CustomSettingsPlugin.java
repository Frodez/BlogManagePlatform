...
public class CustomSettingsPlugin extends PluginAdapter {
	...
	public boolean clientGenerated(Interface interfaze, TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
		...
		interfaze.addSuperInterface(new FullyQualifiedJavaType(MAPPER_NAME + "<" + entityType.getShortName() + ">"));
		...
		interfaze.addJavaDocLine(" * @description " + (introspectedTable.getRemarks() == null ? "" : introspectedTable.getRemarks()));
